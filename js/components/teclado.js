export function teclado() {
	...
	function renderKeyboard() {
		...
		const layers = llavesd.map((layer, i) => {
...
/**
 * Teclado Virtual
 * ? Revisar el codigo para entenderlo mejor
 * ? Darle estylos
 * * Replicarlo solo sin ayuda en react
 * * Pensar como me podria ser util en mi proyecto personal para agregarlo al portafolio
 */
